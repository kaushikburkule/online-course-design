...
class BottomNavigationBehavior : CoordinatorLayout.Behavior<BottomNavigationView> {
    ...
    override fun onNestedPreScroll(coordinatorLayout: CoordinatorLayout, child: BottomNavigationView, target: View, dx: Int, dy: Int, consumed: IntArray) { if (dy < 0) showBottomNavigationView(child) else if (dy > 0) hideBottomNavigationView(child) }
